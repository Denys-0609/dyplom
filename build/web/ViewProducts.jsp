     ...
     %>
      ...
      <section class="slider_section">
         <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
             ...
             while(r.next()){
             %>
             <div class="carousel-inner" style="width:250px;height:220px;border:1px solid gainsboro;float:left;margin-left:30px;">
               <table>
             <tr style="margin:50px;">
                 <td><image src="view.jsp?id=<%=r.getString("id")%>" width="100" height="80"/></td>
                  </tr>
             </table>
                  <table>
                      <tr>
                      <td><a href="ViewProductsDesc.jsp?id=<%=r.getString("id")%>"><input type="button" value="Description"></a>
                 <a href="Order.jsp?id=<%=r.getString("id")%>"><input type="button" value="Add to Cart"></a></td>
                      </tr>
                  </table>
  </div>
         <%}}catch(Exception e){
