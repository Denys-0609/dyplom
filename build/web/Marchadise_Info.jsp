         ...
         <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
          ...
          <div class="carousel-inner" style='width:auto;height:auto;border:none;'>
              ...
              <table>
                  ...
                  <%
                  try{
                      String query="select * from products where status!='Deleted'";
                              ...
                              <td><%=r.getString("pcategory")%></tD>
                                <td><%=r.getString("price")%></tD>
                                  <td><%=r.getString("description")%></tD>
                                    ...
                                    <td><a href="DeleteProduct.jsp?id=<%=r.getString("id")%>">Delete</a></tD>
                                    <td><a href="UpdateProduct.jsp?id=<%=r.getString("id")%>">Update</a></tD>
                        </tr>
