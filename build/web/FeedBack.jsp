<%-- 
    Document   : FeedBack
    Created on : 29 Nov, 2020, 3:43:05 PM
    Author     : KishanVenky
--%>
                ...
                <table style="margin: 40px;">
                    <tr><td style="background: none;border:none;"><a href="Upload.jsp"><h4   style="color:white;">--> Add Products</h4></a></td></tr>
                      <tr><td style="background: none;border:none;"><a href="Behavior.jsp"><h4   style="color:white;">--> User Behavior in graphical format</h4></a></td></tr>
                       <tr><td style="background: none;border:none;"><a href="FeedBack.jsp"><h4   style="color:black;">-->View FeedBack</h4></a></td></tr>
                         </table>
