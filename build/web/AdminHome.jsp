...
<!--<div class="loader"><img src="images/loading.gif" alt="#" /></div>-->
      ...
      <section class="slider_section">
         <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
            <div class="carousel-inner" style='width:400px;height:500px;border:1px solid red;float:right;background: MediumSeaGreen;  box-shadow: 5px 5px #888888;'>
                ...
                <table style="margin: 40px;">
                    <tr><td><a href="Upload.jsp"><h4   style="color:white;">--> Add Products</h4></a></td></tr>
                      <tr><td><a href="Behavior.jsp"><h4   style="color:white;">-->User Behavior in graphical format</h4></a></td></tr>
          ...
          <div class="carousel-inner" style='width:500px;height:500px;border:none;'>
              <h3 style="margin: 40px;float: right;">Welcome <font color="gold">Admin</font></h3>
