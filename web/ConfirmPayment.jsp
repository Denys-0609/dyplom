                     ...
                     <div class="limit-box">
                        <nav class="main-menu" style="width:900px;">
                           <ul class="menu-area-main">
                              ...
                              <li class="active"> <a href="My_Orders.jsp">View Cart</a> </li>
         ...
         <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
             <center>
              ...
              <form action="PaymentAction.jsp" method="post">
                   <table>
                       <tr><th>Card Type:</th><tD><input type="text" name="type" required=""></tD></tr>
                        <tr><th>Card number:</th><tD><input type="number" name="number" required=""></tD></tr>
                         <tr><th>Card cvv:</th><tD><input type="password" name="cvv" required=""></tD></tr>
                           <tr><th>Card Expiry:</th><tD><input type="date" name="expiry" required=""></tD></tr>
