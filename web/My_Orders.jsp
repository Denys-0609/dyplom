                     ...
                     <div class="limit-box">
                        <nav class="main-menu" style="width:900px;">
                           <ul class="menu-area-main">
                              ...
                              <li class="active"> <a href="My_Orders.jsp">Cart</a> </li>
         ...
         <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
             <center>
              ...
              <h2>My Cart Details</h2>
                      ...
                      while(r.next()){
                        ...
                        <tR>
                            ...
                            <td><%=r.getString("o.date")%></tD>
                              ...
                              <td><input type="text" name="price" value="<%=r.getString("p.price")%>"  style="border:none;background:none;width:50px;"> </tD>
                                <td><input type="text" name="pcount" value="<%=r.getString("o.p_count")%>" style="border:none;background:none;width:50px;"> </tD>
                                
                                <td><%=pp%></td>
                                
                                <td><a href="Increse.jsp?id=<%=r.getString("o.id")%>"><font size="20">+</font></a>
                                    <a href="Decrese.jsp?id=<%=r.getString("o.id")%>"><font size="20">-</font></a> 
                                 <a href="Delete.jsp?id=<%=r.getString("o.id")%>">Delete</a></td> 
                        </tr>
               ...
               <center>
                  <a href="ConfirmPayment.jsp"><input type="button" value="Confirm Order & Make Payement" style="height:80px;"></a>
                  </center>
             </center>
                      </center>
 </div>
